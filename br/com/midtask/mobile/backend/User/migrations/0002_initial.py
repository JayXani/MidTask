# Generated by Django 5.2.8 on 2025-12-13 15:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_status', models.CharField(choices=[('A', 'ACTIVATE'), ('B', 'BLOCKED'), ('D', 'DEACTIVATE')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('per_app_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ...
                ('users', models.ManyToManyField(related_name='mobile_permissions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ChangeLog',
